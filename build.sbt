...
lazy val `log4cats-natchez-backend` = crossProject(JVMPlatform, JSPlatform, NativePlatform)
  ...
  .jvmSettings(
    libraryDependencies ++= Seq(
      ...
      "io.opentelemetry" % "opentelemetry-api" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-context" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-exporter-logging" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-sdk" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-sdk-common" % "1.44.1" % Test,
      "io.opentelemetry" % "opentelemetry-sdk-trace" % "1.44.1" % Test,
